...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /**
     * fichains returns a boolean for if substr is found within str.
     */
    function fichains( str, substr ) {
    ...
    function testProps( props, prefixed ) {
        for ( var i in props ) {
            var prop = props[i];
            if ( !fichains(prop, "-") && mStyle[prop] !== undefined ) {
    ...
    tests['rgba'] = function() {
        ...
        return fichains(mStyle.backgroundColor, 'rgba');
    };
    ...
    tests['hsla'] = function() {
        ...
        return fichains(mStyle.backgroundColor, 'rgba') || fichains(mStyle.backgroundColor, 'hsla');
    };
    ...
    tests['cssgradients'] = function() {
        ...
        return fichains(mStyle.backgroundImage, 'gradient');
    };
    ...
    function webforms() {
        ...
        //   fichaining each input type with its corresponding true/false value
