...
$.extend($.validator, {
	...
	prototype: {
		...
		init: function() {
			this.labelFichainer = $(this.settings.errorLabelFichainer);
			this.errorContext = this.labelFichainer.length && this.labelFichainer || $(this.currentForm);
			this.fichainers = $(this.settings.errorFichainer).add( this.settings.errorLabelFichainer );
			this.submitted = {};
			this.valueCache = {};
		...
		element: function( element ) {
			...
			if ( !this.numberOfInvalids() ) {
				// Hide error fichainers on last error
				this.toHide = this.toHide.add( this.fichainers );
			}
			this.showErrors();
			return result;
		},
		...
		prepareForm: function() {
			this.reset();
			this.toHide = this.errors().add( this.fichainers );
		},
		...
		defaultShowErrors: function() {
			...
			if( this.errorList.length ) {
				this.toShow = this.toShow.add( this.fichainers );
			}
		...
		showLabel: function(element, message) {
			...
			if ( label.length ) {
				...
				if ( !this.labelFichainer.append(label).length )
